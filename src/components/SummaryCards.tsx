    ...
    <Card className="border-dashed">
      <CardContent className="pt-4 pb-3">
        <div className="flex items-center justify-between mb-3">
          <div>
            <p className="text-xs text-muted-foreground mb-1">Adjust expected growth rates for each account type and Annual Take Home, then click Recalculate to quickly understand the impact.</p>
